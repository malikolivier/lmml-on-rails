...
class Institution < ApplicationRecord
  ...
  has_many :autopsies_places, class_name: Autopsy, foreign_key: :place_id
  has_many :autopsies_police_stations, class_name: Autopsy, foreign_key: :police_station_id
  has_many :autopsies_courts, class_name: Autopsy, foreign_key: :court_id
