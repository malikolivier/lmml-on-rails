...
LMML.loaders.external_face_examination = function () {
  ...
  LMML.loadVueModel(model, {
    methods: {
      add_foreign_fluid: LMML.add_('foreign_fluid', [model, 'external_mouth_examination']),
      delete_foreign_fluid: LMML.delete_('foreign_fluid', [model, 'external_mouth_examination'])
    }
  })
}
