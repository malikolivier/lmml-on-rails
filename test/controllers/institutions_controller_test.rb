...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post institutions_url, params: { institution: { address: @institution.address, name: @institution.name } }
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { address: @institution.address, name: @institution.name } }
